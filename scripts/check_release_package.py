...
COMPOSITION_BENCHMARK_MINIMUM_VERSION = (
    _release_package_benchmark.COMPOSITION_BENCHMARK_MINIMUM_VERSION
)
COMPOSITION_BENCHMARK_SUMMARY_SCHEMA = (
...
def composition_benchmark_required(version: str) -> bool:
    return _release_package_benchmark.composition_benchmark_required(version)
...
def resolve_composition_benchmark_inputs(
    *,
    ...
    return _release_package_benchmark.resolve_composition_benchmark_inputs(
...
def check_composition_benchmark(
    ...
    *,
    ...
    return _release_package_benchmark.check_composition_benchmark(
        plugin_root,
        observations_path,
        run_plan_path=run_plan_path,
        semantic_proposals_path=semantic_proposals_path,
        ...
        release_version=release_version,
        run_json=run_json,
        resolve_inputs=resolve_composition_benchmark_inputs,
        validate_summary=validate_benchmark_summary,
    )
...
def check_package(
    ...
    *,
    ...
    benchmark_artifact_paths, benchmark_input_error = (
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        type=Path,
        help=(
            "Explicit host-run composition benchmark observations. Supplying any "
            "benchmark input requires all six inputs. TMCP 0.6.0 and newer use "
            "the Git-clean docs/COMPOSITION_BENCHMARK_BUNDLE by default."
        ),
    )
