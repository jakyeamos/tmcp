...
from scripts.composition_benchmark_bundle_scanning import (  # noqa: E402
    CompositionBenchmarkBundleError,
    scan_sensitive_serialization as _scan_sensitive_serialization,
)
...
def _manifest_fields(*, artifact_hashes: Mapping[str, str]) -> dict[str, Any]:
    artifacts = {
        filename: {
