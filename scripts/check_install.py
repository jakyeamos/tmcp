...
REQUIRED_FILES = (
    ...
    "examples/host-policy-compositional-routing.md",
    "docs/COMPOSITION_BENCHMARK.md",
    ...
    "schemas/tmcp-composition-behavioral-fixtures-v0.1.schema.json",
    ...
    "schemas/tmcp-composition-benchmark-execution-context-v0.1.schema.json",
    ...
    "schemas/tmcp-composition-benchmark-receipt-provenance-v0.1.schema.json",
    ...
    "schemas/tmcp-composition-routing-golden-v0.1.schema.json",
    "schemas/tmcp-project-composition-recipe-v0.1.schema.json",
    "schemas/tmcp-project-recipe-promotion-v0.1.schema.json",
    ...
    "scripts/composition_benchmark_bundle_scanning.py",
    "scripts/release_package_benchmark.py",
    "scripts/release_package_compile.py",
    "scripts/release_package_composition.py",
    "scripts/prepare_composition_benchmark.py",
    "scripts/assemble_composition_benchmark.py",
    ...
    "scripts/prepare_composition_lift_dispatches.py",
    "scripts/run_composition_benchmark.py",
    "scripts/release_package_sessions.py",
    "tests/fixtures/composition_behavioral_fixtures_v0_6.json",
    "tests/fixtures/composition_routing_golden_v0_6.json",
    ...
    "tmcp_runtime/domain/behavior_manifests.py",
    "tmcp_runtime/domain/behavior_manifest_hydration.py",
    "tmcp_runtime/domain/behavior_manifest_primitives.py",
    "tmcp_runtime/domain/composition_benchmark_contracts.py",
    "tmcp_runtime/domain/composition_benchmark_context.py",
    "tmcp_runtime/domain/composition_benchmark_assembly.py",
    "tmcp_runtime/domain/composition_benchmark_receipt_projection.py",
    "tmcp_runtime/domain/composition_benchmark_boundaries.py",
    "tmcp_runtime/domain/composition_benchmark_evidence.py",
    ...
    "tmcp_runtime/domain/composition_benchmark_projection.py",
    "tmcp_runtime/domain/composition_benchmark_receipts.py",
    "tmcp_runtime/domain/composition_benchmark_recipes.py",
    "tmcp_runtime/domain/composition_benchmark_routing.py",
    "tmcp_runtime/domain/composition_benchmark_replay.py",
    ...
    "tmcp_runtime/domain/composition_phase_capsules.py",
    "tmcp_runtime/domain/composition_phase_capsule_support.py",
    "tmcp_runtime/domain/composition_phase_bindings.py",
    "tmcp_runtime/domain/composition_phase_slice_closures.py",
    ...
    "tmcp_runtime/domain/harvest_node_policy.py",
    ...
    "tmcp_runtime/domain/source_activation_projection.py",
    ...
    "tmcp_runtime/storage/project_recipe_promotion_validation.py",
    ...
    "tmcp_runtime/services/composition_scoring.py",
