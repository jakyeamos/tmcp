...
REQUIRED_FILES = (
    ...
    "schemas/tmcp-codex-validation-preflight-v0.1.schema.json",
    "schemas/tmcp-codex-desktop-bridge-build-v0.1.schema.json",
    "schemas/tmcp-codex-validation-bootstrap-v0.1.schema.json",
    "schemas/tmcp-codex-validation-toolchain-v0.1.schema.json",
    "schemas/tmcp-composed-packet-v0.1.schema.json",
    "schemas/tmcp-coordinator-state-v0.1.schema.json",
    ...
    "tmcp_runtime/domain/behavioral_atom_compiler.py",
    "tmcp_runtime/domain/behavioral_atom_registry.py",
    "tmcp_runtime/domain/behavioral_atom_renderer.py",
    "tmcp_runtime/domain/behavioral_atom_types.py",
    "tmcp_runtime/domain/behavioral_atoms.py",
    "tmcp_runtime/domain/declared_loads.py",
    "tmcp_runtime/domain/composition.py",
    "tmcp_runtime/domain/coordination.py",
    ...
    "tmcp_runtime/domain/route_resolution.py",
    "tmcp_runtime/domain/signal_text.py",
    ...
    "tmcp_runtime/services/behavioral_atom_evaluation.py",
    "tmcp_runtime/services/behavioral_atom_h3.py",
    "tmcp_runtime/services/behavioral_atom_projection.py",
    "tmcp_runtime/services/behavioral_atom_runtime.py",
