...
class ReleasePackageTests(unittest.TestCase):
    ...
    def test_package_allows_documented_checksum(self) -> None:
        ...
        self.package.scan_release_content(
            "README.md", f'{{"sha256": "{checksum}"}}\n'.encode("utf-8")
        )
        self.package.scan_release_content(
            "README.md", f'{{"source_sha256": "{checksum}"}}\n'.encode("utf-8")
        )
        self.package.scan_release_content(
    ...
    def test_package_allows_path_shaped_placeholder(self) -> None:
        ...
        versioned_identifier = "tmcp-invocation-admission-overhead-pilot-v0.5"
        self.package.scan_release_content(
            "README.md", versioned_identifier.encode("utf-8")
        )
