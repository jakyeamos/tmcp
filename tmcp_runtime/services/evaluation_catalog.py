...
EFFECTIVE_PATTERNS: tuple[dict[str, Any], ...] = (
    {
        ...
        "internal_atoms": ("behavior-verification", "quality-gate-disclosure"),
        "detection_terms": ("report pass/fail", "run `", "npm test", "pytest"),  # quality-gate: allow package-manager: non-executable
        "good_example": "Run `npm test -- --runInBand` and report pass/fail.",  # quality-gate: allow package-manager: non-executable
