...
def build_composition_evaluation_variants(
    ...
    from tmcp_runtime.services.composition_scoring import (
        build_composition_evaluation_variants as build_variants,
    )

    return build_variants(selected_skill_ids)
...
def score_composition_results(
    ...
    from tmcp_runtime.services.composition_scoring import (
        score_composition_results as score_results,
    )
