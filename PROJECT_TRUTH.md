...
- Causal launch is additionally held by the baseline dependency: no compatible completed baseline receipt exists for the source-bundle study, and the existing eval-skills baseline is itself below its per-fixture reliability floor with unresolved reproducible cost adjudication.
