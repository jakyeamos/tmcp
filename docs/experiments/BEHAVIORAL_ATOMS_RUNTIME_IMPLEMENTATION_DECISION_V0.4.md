...
- Authorized handoff:
  `<external-handoff-root>/behavioral-atoms-preflight-v0.3/HANDOFF.md`
- Authorized manifest:
  `<external-handoff-root>/behavioral-atoms-preflight-v0.3/manifest.json`
- Source snapshot: `<source-snapshot-root>/tmcp`
...
`<source-snapshot-root>/tmcp` to the listed repository-relative
