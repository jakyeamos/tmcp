...
- Authorized handoff:
  `<TMCP_EVIDENCE_ROOT>/handoffs/behavioral-atoms-preflight-v0.3/HANDOFF.md`
- Authorized manifest:
  `<TMCP_EVIDENCE_ROOT>/handoffs/behavioral-atoms-preflight-v0.3/manifest.json`
- Source snapshot: `<TMCP_WORKTREE_ROOT>`
...
`<TMCP_WORKTREE_ROOT>` to the listed repository-relative
