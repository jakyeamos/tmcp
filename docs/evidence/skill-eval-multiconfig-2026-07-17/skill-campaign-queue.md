...
| `/Users/jakyeamos/skills/engineering/refactor-clean/SKILL.md` | Packet-probed | One owner, stale-path removal, consumer verification | Independently review a small dependency-graph fixture and first-principles bar before deciding whether a behavioral plan is warranted. |
...
| TMCP compiler + `refactor-clean` | Packet-probed | The packet preserves a consumer-surface verification gate; ownership behavior and the stale-path outcome remain untested. | Independently reviewed dependency-graph fixture, first-principles bar, and preregistered behavioral plan. |
