...
This bar is predeclared for the condition-blind rejudge of all 36 fixed runner
artifacts in the fresh intact-skill baseline. It is limited to the binary
`cost_regression` verdict; it does not revisit task correctness, safety, or the
