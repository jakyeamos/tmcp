...
Current score: 100/100 for the scoped `0.5.8` AIOS deprecation boundary and
nested-Git isolation, 0.5.7 rubric-coverage and executable-launcher fixes,
0.5.6 native-Git provenance inference, 0.5.5 native-marketplace
